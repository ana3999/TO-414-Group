...
#### Approach 
* Explain Client Profile method
* Explain hotel seperation 
...
## Variable  Validation
* Include variable cut-off explanation
...
```
```{r}
Stay_in_weekend_nights <- aggregate(is_canceled ~ stays_in_weekend_nights, data = hotels, sum, decreasing = TRUE)
Stay_in_weekend_nights$is_canceled
barplot(Stay_in_weekend_nights$is_canceled/nrow(hotels), col=Stay_in_weekend_nights$Stays_in_weekend_nights)
```
